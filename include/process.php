...
<thead class="thead">
<th class="horarioheader"><i class="fa fa-clock-o"></i> Horário</th>
';
for ($i=0; $i < $countdays; $i++) { 
 if ($dias[$i] == 1) {
  echo '<th><i class="fa fa-angle-right"></i> Segunda</th>';
 }elseif ($dias[$i] == 2){
  echo '<th><i class="fa fa-angle-right"></i> Terça</th>';
 }elseif ($dias[$i] == 3){
  echo '<th><i class="fa fa-angle-right"></i> Quarta</th>';
 }elseif ($dias[$i] == 4){
  echo '<th><i class="fa fa-angle-right"></i> Quinta</th>';
 }elseif ($dias[$i] == 5){
  echo '<th><i class="fa fa-angle-right"></i> Sexta</th>';
 }elseif ($dias[$i] == 6){
  echo '<th><i class="fa fa-angle-right"></i> Sábado</th>';
 }elseif ($dias[$i] == 7){
...
<button class="guardarhorario btn btn-lg btn-warning pull-right"><i class="fa fa-floppy-o"></i> Salvar</button>
